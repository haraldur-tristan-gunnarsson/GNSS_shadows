...
#ifdef LINMATH_H_USE_DOUBLE//Added by Haraldur Tristan Gunnarsson 2014-11-22:
#define float double
#define cosf(x) cos((x))
#define sinf(x) sin((x))
#define tanf(x) tan((x))
...
#endif//End Haraldur's additions
...
#ifdef LINMATH_H_USE_DOUBLE//Added by Haraldur Tristan Gunnarsson 2015-10-23:
#undef float
#undef cosf 
#undef sinf
#undef tanf
